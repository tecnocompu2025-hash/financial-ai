...
export type DashboardSummary = { income_total: number; expense_total: number; asset_total: number; liability_total: number; cash_flow: number; net_worth: number; savings_rate: number; debt_total: number; debt_ratio: number };
